  ...
  return (
    <div className="w-screen aspect-video pt-[20%] px-24 absolute text-white bg-gradient-to-r from-black">
      ...
      <div className="">
        ...
        <button
          type="button"
          className=" hover:cursor-pointer border border-gray-800 hover:bg-gray-900 focus:ring-4 focus:outline-none focus:ring-gray-300 font-medium px-7 py-2.5 text-center me-2 mb-2 dark:border-gray-600  dark:hover:text-white dark:hover:bg-gray-400 rounded-sm dark:focus:ring-gray-800"
        >
